    ...
    <aside className="order-2 lg:order-1 w-full lg:w-72 xl:w-80 shrink-0 lg:h-full lg:min-h-[44rem] lg:overflow-y-auto border-t lg:border-t-0 border-gray-100 lg:border-r bg-white pb-2 lg:pb-8 flex flex-col">
      ...
      <div className="px-5 pt-2 space-y-3 text-xs flex-1 flex flex-col">
        <button
          ...
          className="flex items-center justify-between w-full pb-2 border-b border-gray-200 text-xs font-mono tracking-[0.2em] font-bold uppercase cursor-pointer hover:opacity-70 transition-opacity"
